function [bestmem,bestval,nfeval,Alldata] = devec3_AdaptedJT(fname,VTR,D,XVmin,XVmax,y,NP,itermax,F,CR,strategy,refresh);
...
% added JT, for plotting
Alldata(iter,:)=[ iter bestval bestmem];
